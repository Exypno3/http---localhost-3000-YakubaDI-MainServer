...
public class CevFactInvcsPackage {
    private CPackageInformation p10_packinf;
    private CevFactInvcs evFactInvcs;

    public CevFactInvcsPackage() {
        this.evFactInvcs = new CevFactInvcs();
    }
    ...
    public CevFactInvcs getEvFactInvcs() {
        return evFactInvcs;
    }

    public void setEvFactInvcs(CevFactInvcs evFactInvcs) {
        this.evFactInvcs = evFactInvcs;
    }
